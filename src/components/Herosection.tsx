  ...
  return (
    <div className="w-full relative min-h-screen overflow-hidden">
      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-center h-full text-center px-4">
        ...
        >
          Platform for real-time vehicle tracking and fleet management, providing dispatchers with live updates on vehicle locations, routes, and statuses to optimize operations and enhance efficiency.
        </motion.p>
        <motion.div
