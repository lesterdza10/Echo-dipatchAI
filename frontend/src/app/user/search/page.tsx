...
const vehicle_meta: any = {
  ...
  miniTruck: { label: "Mini Truck", icon: CircleGauge },
        ...
        <div className="px-5 lg:px-8 max-w-6xl mx-auto">
            ...
            <div>
              ...
              {meta && (
                <div className="text-xs mt-0.5 text-zinc-500">
                  {meta.label} vehicles near your pickup
                </div>
              )}
            </div>
            <AnimatePresence mode="wait">
              {loading ? (
                <motion.div
                  ...
                  className="flex items-center gap-2 bg-zinc-100 border border-zinc-200
          ...
          <AnimatePresence>
            {!loading && nearbyVehicles.length === 0 && (
              ...
              >
                <div
                  className="w-20 h-20 rounded-full bg-zinc-100 border
                ...
                <p className="text-zinc-500 text-sm max-w-xs leading-realxed">
