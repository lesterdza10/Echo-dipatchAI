              ...
              <div className="flex items-end justify-between pt-6 border-t border-zinc-100">
                <div>
                  ...
                  <p className="text-zinc-400 text-xs font-medium">
                    Includes base and distance charges
                  </p>
                </div>
                      ...
                      {[
                        {
                          ...
                          Icon: Banknote,
                          title: "Cash",
                          sub: "Pay driver after collection",
                        },
                        {
                          id: "online",
                          Icon: Wallet,
                ...
                {status == "confirmed" && (
                  ...
                  >
                    ...
                    <div>
                      ...
                      >
                        Your booking is confirmed. Your vehicle is on the way.
                        Track live from the ride screen.
                      </motion.p>
                    </div>
                    ...
                    >
                      Track Your Vehicle <ArrowRight size={16} />
                    </motion.button>
                  </motion.div>
                )}
              </AnimatePresence>
