...
const TYPE_CONFIG = {
  ...
  "mini-truck": { label: "Mini Truck", Icon: CircleGauge },
  "dump-truck": { label: "Dump Truck", Icon: Truck },
};
...
function VehicleCard({
  ...
  if (vehicle.baseFare && vehicle.pricePerKm && vehicle.waitingCharge) {
    estimated = Math.round(
      vehicle.baseFare +
        vehicle.pricePerKm * (distance || 0) +
        vehicle.waitingCharge * 1,
    );
  }
  return (
    <motion.div
    ...
    >
      <div className="relative h-48 bg-zinc-50 flex items-center justify-center overflow-hidden">
        ...
        <div
          className="absolute bottom-3 left-3 z-20 flex items-center gap-1.5 bg-white border border-zinc-200
        text-zinc-700 text-[10px] font-bold shadow-sm px-2.5 py-1.5 rounded-full"
        >
      ...
      <div className="flex flex-col flex-1 p-5 gap-4">
        ...
        <div className="grid grid-cols-2 gap-2">
          <div className="bg-zinc-50 border border-zinc-100 rounded-2xl px-3.5 py-3">
            ...
            <p className="text-zinc-900 text-sm font-black flex items-center tracking-tight">
              <IndianRupee size={12} />
              {vehicle.pricePerKm}
            </p>
          </div>
          <div className="bg-zinc-50 border border-zinc-100 rounded-2xl px-3.5 py-3">
            ...
            <div className="text-zinc-900 text-sm font-black flex items-center tracking-tight">
              <IndianRupee size={11} className="text-zinc-900" />
        ...
        <div className="flex items-center justify-between pt-3 border-t border-zinc-100">
          <div>
            <p className="text-zinc-500 text-[9px] mb-0 uppercase tracking-widest font-bold">
              Est. Fare
            </p>
            <motion.div
              key={estimated}
